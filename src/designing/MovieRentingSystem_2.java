...
// issue found : instead of creating a return list of size 5, I was creating <= 5 means 6 :../
class MovieRentingSystem_2 {
    ...
    public MovieRentingSystem_2(int n, int[][] entries) {
