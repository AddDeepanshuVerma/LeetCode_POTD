...
// issue found : report methods temp priorityQueue was saving duplicate data & gave us the same
class MovieRentingSystem_3 {
    ...
    public MovieRentingSystem_3(int n, int[][] entries) {
